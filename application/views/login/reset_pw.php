                ...
                <div class="block-all-inside col-sm-12 block-height-100 test">
                    ...
                    <div class="container block-height-100 index-body">
                        ...
                        <?php echo form_open('login/do_reset_password'); ?>
                            ...
                            <input type="password" class="color-input color-text-back input-login" name="password" placeholder="password">
                            <input type="password" class="color-input color-text-back input-login" name="confirmpassword" placeholder="confirm password">

                            <input type="submit" value="wachtwoord herstellen" class="ingredient-menu-button color-text mt-4">
                        </div>
                    </div>
                </div>
            </div>
